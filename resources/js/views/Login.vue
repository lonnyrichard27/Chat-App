...
<script>
    ...
    export default {
        ...
        methods: {
            // this method will get the value of the username and password and send to the backend for authentication
            authLoginAppUser() {
                let userData = {
...
// logging in the user using the returned authToken
    function logUserInToCometChat(token) {

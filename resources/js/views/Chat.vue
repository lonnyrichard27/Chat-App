...
<script>
    ...
    export default {
        ...
        const messagesRequest = new CometChat.MessagesRequestBuilder()
            ...
            // this method fetches the previous messages from chats of a user
    ...
    // the send message function is trigeered when a user sends a message in a grouo conversation
